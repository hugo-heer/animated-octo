...
function init() {
    ...
    player1 = new Player("player1", 0xffff00, new THREE.Vector2(-250, 0), 0);
    scene.add(player1.graphic);

    /*player2 = new Player("player2", 0xffff00, new THREE.Vector2(-250, 0), 0);
    scene.add(player2.graphic);*/


    ennemy1 = new Ennemy("ennemy1", 0x5e176a, new THREE.Vector2(0, 0), 0);
...
function Ground(color, size_x, size_y, nb_tile) {
    ...
    tmpGround = new THREE.Mesh(
        ...
        new THREE.MeshLambertMaterial({ color: 0x6d2aff, transparent: false, opacity: 1 }));
...
function Light(name, color, position) {
    pointLight = new THREE.PointLight(color, WIDTH * 2, HEIGHT * 2);
